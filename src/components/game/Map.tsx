...
const Map = (props: MapProps) => {
    ...
    useEffect(() => {
        ...
        map.current.on('click', (e: any) => {
            ...
            fetch(`/mapboxtiles/v4/geocode/mapbox.places-country-v1/${lng},${lat}.json?access_token=pk.eyJ1IjoiZG9yaXQ3NSIsImEiOiJjbGFqdjU1bzYwZzBhM3NvMGJ0Z2M1a3F2In0.RddpBuye5jg57iGg25DQTA&language=fr`)
            .then(data => data.json())
            .then(data => {
